...
use mysql;
CREATE USER 'emsuser'@'%' IDENTIFIED BY 'emsuser#123';
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, ALTER, CREATE ROUTINE, ALTER ROUTINE, EXECUTE ON STATegraDB.* TO 'emsuser'@'%';
flush privileges;
