...
ALTER TABLE biocondition ADD COLUMN network_host varchar(200);
ALTER TABLE biocondition ADD COLUMN network_service varchar(200);
ALTER TABLE biocondition ADD COLUMN network_sample_type varchar(200);
