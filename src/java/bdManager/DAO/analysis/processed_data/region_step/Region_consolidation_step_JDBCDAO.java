...
// */
//public class Region_consolidation_step_JDBCDAO extends ProcessedData_JDBCDAO {
//
////******************************************************************************************************************************************/
////*** INSERT FUNCTIONS *********************************************************************************************************************/
////******************************************************************************************************************************************/
...
//        super.insert(object);
//        Region_consolidation_step region_consolidation_step = (Region_consolidation_step) object;
//
...
//                + "WHERE step_id = ?");
//
//        ps.setString(1, region_consolidation_step.getProcessedDataType());
//        ps.setString(2, region_consolidation_step.getMotivation());
//        ps.setString(3, region_consolidation_step.getStepID());
//        ps.execute();
//
//        for (RegionElement region_element : region_consolidation_step.getConsolidated_data()) {
...
//     */
//    @Override
//    public Region_consolidation_step findByID(String step_id, Object[] otherParams) throws SQLException {
//        Region_consolidation_step regionStepInstance = new Region_consolidation_step();
...
//        }
//
//        regionStepInstance.setConsolidated_data(regions.toArray(new RegionElement[]{}));
...
////        ResultSet rs = (ResultSet) DBConnectionManager.getConnectionManager().execute(ps, true);
////
////        Region_consolidation_step regionStepInstance = null;
