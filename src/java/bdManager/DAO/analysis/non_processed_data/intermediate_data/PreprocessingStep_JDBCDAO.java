 ...
 */
public class PreprocessingStep_JDBCDAO extends IntermediateData_JDBCDAO {
...
//******************************************************************************************************************************************/
    ...
    public boolean insert(Object object) throws SQLException {
        ...
        super.insert(object);
        Preprocessing_step preprocessing_step = (Preprocessing_step) object;
        ...
        int i = 1;
        ps.setString(i, preprocessing_step.getPreprocessingType());i++;
        ps.setString(i, preprocessing_step.getStepID());
        ps.execute();
    ...
    public boolean update(Object object) throws SQLException {
        ...
        ps.setString(1, preprocessing_step.getPreprocessingType());
        ps.setString(2, preprocessing_step.getStepID());
        ps.execute();
    ...
    public ArrayList<Object> findAll(Object[] otherParams) throws SQLException {
        ...
        PreparedStatement ps = (PreparedStatement) DBConnectionManager.getConnectionManager().prepareStatement(""
                ...
                + "AND t1.intermediate_data_type = 'preprocessing_step'");

        ps.setString(1, analysis_id);

        ResultSet rs = (ResultSet) DBConnectionManager.getConnectionManager().execute(ps, true);
        ArrayList<Object> preprocessing_steps = new ArrayList<Object>();
        Preprocessing_step intermediate_data_instance = null;

        DAO quality_report_dao = DAOProvider.getDAOByName("QualityReport");
        while (rs.next()) {
            //SET THE INTERMEDIATE DATA FIELDS
            intermediate_data_instance = new Preprocessing_step();
            ...
            intermediate_data_instance.setPreprocessing_type(rs.getString("preprocessing_type"));
            ...
            preprocessing_steps.add(intermediate_data_instance);
        }
