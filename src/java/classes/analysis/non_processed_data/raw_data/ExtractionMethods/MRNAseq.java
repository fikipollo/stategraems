 ...
 */
public class MRNAseq extends Sequencing {
...
////    protected String library_construction_protocol;
     ...
     */
    public static MRNAseq fromJSON(String jsonString) {
        Gson gson = new Gson();
        MRNAseq rnaseq_rawdata = gson.fromJson(jsonString, MRNAseq.class);

        return rnaseq_rawdata;
    }
