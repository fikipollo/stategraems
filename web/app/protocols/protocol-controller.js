...
(function () {
     ...
     *                                                                                  
     ******************************************************************************/
    app.controller('ProtocolListController', function ($rootScope, $scope, $http, $stateParams, $dialogs, APP_EVENTS, ProtocolList) {
        /******************************************************************************      
        ...
        if ($scope.protocols.length === 1 || $stateParams.force || $scope.force) { //includes the default protocol
