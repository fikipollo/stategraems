    ...
    initComponent: function () {
        ...
        var datatypeCombo = new Ext.form.ComboBox({
            store: new Ext.data.SimpleStore({
                ...
                data: [
                    ...
                    ["Relevant Genes list"], 
                    ["Metabolomic quatification"], 
                    ["Relevant Compound list"], 
                    ["Proteomic quatification"], 
                    ["Relevant proteins list"], 
                    ["Bed file (regions)"], 
                    ["Relevant regions list"],
                    ["GTF file"]
                ]
            }),
        ...
        Ext.apply(this, {
            ...
            columns: [
                ...
                {dataIndex: 'filename', header: this.textFilename, flex: 1},
                {dataIndex: 'dataType', header: this.textDataType, width: 150, editor: datatypeCombo, allowBlank: false},
